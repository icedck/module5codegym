...
export default class App extends Component {
  constructor(props) {
    ...
    this.state = {
      studentList: [
        { name: "stu1", phone: "09123456789", email: "stu1@gmail.com" },
        { name: "stu2", phone: "0932432333", email: "stu2@gmail.com" },
        { name: "stu3", phone: "093243332112", email: "stu2@gmail.com" },
      ],
  ...
  checkInvalidForm = () => {
    ...
    const isValid = name && phone && email && isPhoneValid;
